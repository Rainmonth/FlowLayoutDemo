...
public class TagCloudView extends ViewGroup {
    ...
    private static final int SELECT_TEXT_COLOR = R.color.yellow_bg;//选中后的标签颜色
    private static final int DEFAULT_TEXT_SIZE = 14;
    private static final int DEFAULT_TEXT_BACKGROUND = R.drawable.tag_cloud_view_tag_item_background;
    ...
    private static final int DEFAULT_TAG_RES_ID = R.layout.tag_cloud_view_item;
    ...
    public TagCloudView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSelectTagColor = a.getColor(R.styleable.TagCloudView_tcvSelectTextColor, getResources().getColor(SELECT_TEXT_COLOR));
        ...
        mTagResId = a.getResourceId(R.styleable.TagCloudView_tcvTagResId, DEFAULT_TAG_RES_ID);
