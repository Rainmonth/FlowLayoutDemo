...
import com.rainmonth.view.TagCloudView;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

public class TagCloudViewDemo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tag_cloud_view_demo);
    ...
    private void bindPositionView(int position) {
        ...
        for (int i = 0; i < AllTagsPosition.size(); i++) {
            if (map.get(i)) {
                positionsView.getChildAt(i).setBackgroundResource(R.drawable.tag_cloud_view_edit_style_yellow);
            }
        }
    }
    ...
    private void bindSelectUseView(int selectLength) {
        ...
        for (int i = 0; i < AllTagsSelect.size(); i++) {
            if (i < selectLength) {
                ...
                selectTagUseView.getChildAt(i).setBackgroundResource(R.drawable.tag_cloud_view_edit_style_yellow);
            } else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.tag_cloud_view_menu, menu);
        return true;
    }
